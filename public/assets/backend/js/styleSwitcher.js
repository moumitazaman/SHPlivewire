...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'light'){
			jQuery(".nav-header .logo-abbr").attr("src", "../../assets/backend/images/logo.png");
			jQuery(".nav-header .logo-compact").attr("src", "../../assets/backend/images/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src", "../../assets/backend/images/logo-text.png");

			setCookie('logo_src', 'images/logo.png');
			setCookie('logo_src2', 'images/logo-text.png');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "../../assets/backend/images/logo-white.png");
			jQuery(".nav-header .logo-compact").attr("src", "../../assets/backend/images/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "../../assets/backend/images/logo-text-white.png");
